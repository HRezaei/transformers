# coding=utf-8
# Copyright 2020, The T5LA Authors and HuggingFace Inc.
#
...
class T5LAConfig(PretrainedConfig):
    r"""
    This is the configuration class to store the configuration of a [`T5LAModel`] or a [`TFT5LAModel`]. It is used to
    ...
    Arguments:
        vocab_size (`int`, *optional*, defaults to 32128):
            ...
            `inputs_ids` passed when calling [`T5LAModel`] or [`TFT5LAModel`].
...
__all__ = ["T5LAConfig", "T5LAOnnxConfig"]
