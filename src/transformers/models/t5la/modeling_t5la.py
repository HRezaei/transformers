...
class T5LaBlock(GradientCheckpointingLayer):
    def __init__(self, config, has_relative_attention_bias=False, layer_idx: Optional[int] = None):
        super().__init__()
        self.is_decoder = config.is_decoder
...
class T5LaModel(T5LaPreTrainedModel):
    ...
    def forward(
        ...
        >>> model = T5LaModel.from_pretrained("google-t5la/t5la-small")
...
class T5LaEncoderModel(T5LaPreTrainedModel):
    ...
    def forward(
        ...
        >>> tokenizer = AutoTokenizer.from_pretrained("google-t5la/t5la-small")
        >>> model = T5LaEncoderModel.from_pretrained("google-t5la/t5la-small")
        >>> input_ids = tokenizer(
        ...     "Studies have been shown that owning a dog is good for you", return_tensors="pt"
        ... ).input_ids  # Batch size 1
